...
% ana, donel, matteo, adam, yann, albert
...
%  steve, vivien, cesar, zhaoxia, nahian, anthony
% A = [0, 22.5, -22.5, 45, -45, 67.5, 135, 90, 112.5];
% B = [-45, -22.5, 135, 0, 112.5, 22.5, 90, 45, 67.5];
% C = [67.5, 45, 90, 22.5, 112.5, 0, 135, -22.5, -45];
% D = [112.5, 90, 135, 67.5, -45, 45, -22.5, 22.5, 0];
